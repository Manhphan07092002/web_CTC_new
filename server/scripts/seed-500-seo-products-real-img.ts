...
const PRODUCT_CATALOG: {
  ...
  // ─── BỔ SUNG: UPS / NGUỒN LƯU ĐIỆN ──────────────────────────────────
  {
    parentCategory: 'Thiết Bị CNTT',
    category: 'UPS Nguồn Lưu Điện',
    slug: 'ups-nguon-luu-dien',
    brand: 'APC / Emerson',
    imageQuery: 'APC Smart-UPS online rack mount 1500VA official product',
    fallbackKey: 'battery',
    quota: 20,
    products: [
      'APC Smart-UPS SRT3000XLI 3000VA On-Line', 'APC Smart-UPS SMT1500IC 1500VA',
      'APC Smart-UPS SMT2200IC 2200VA Tower', 'APC Smart-UPS SRT5KXLI 5kVA Rack',
      'APC Smart-UPS SRT10KXLI 10kVA 3P', 'APC Back-UPS BE900G2-AS 900VA',
      'APC Back-UPS Pro BP1400MI 1400VA', 'APC Symmetra PX SYPX40KH 40kVA Modular',
      'Emerson Liebert GXT4 2000VA Rack Tower', 'Emerson Liebert GXT5-1500MT120 1500VA',
      'Emerson Liebert EXM 10kVA 3-Phase', 'Emerson Liebert PSI5 1500VA',
      'Eaton 5P1150IR 1150VA Rack 2U', 'Eaton 9PX2000IRT2U 2000VA',
      'Eaton 9SX5KIRTN 5kVA On-Line', 'CyberPower OL2000ERTXL2U 2000VA',
      'CyberPower OL10000ERT3U 10kVA 3P', 'Vertiv Liebert PSI5 2200VA',
      'Riello UPS Dialog Vision 1500kVA', 'Socomec NETYS RT 3000VA On-Line',
    ],
  },

  // ─── BỔ SUNG: TỦ RACK & PHỤ KIỆN ─────────────────────────────────────
  {
    parentCategory: 'Thiết Bị CNTT',
    category: 'Tủ Rack & Phụ Kiện',
    slug: 'tu-rack-phu-kien',
    brand: 'APG / CKL',
    imageQuery: 'server rack cabinet 42U 19 inch floor standing network enclosure official',
    fallbackKey: 'server',
    quota: 20,
    products: [
      'Tủ Rack 42U 19" Floor Stand D=800mm Glass Door', 'Tủ Rack 27U 19" D=600mm Swing Type',
      'Tủ Rack 12U 19" Wall Mount D=450mm', 'Tủ Rack 6U 19" Wall Mount Shallow D=350mm',
      'Tủ Rack 22U 19" Floor D=600mm Perforated Door', 'APC NetShelter SX 42U AR3150',
      'APC NetShelter SX 24U AR3104', 'APC NetShelter SX 12U Wall Mount AR112HD6',
      'Hoffman Enclosure PROLINE 600x600x42U', 'APG Rack 42U 800x1000 Premium',
      'Tủ Rack Open Frame 42U 4-Post OFR4210BK', 'PDU 1U Rack 8 Outlet C13 16A',
      'PDU APC AP7555 Switched Rack 2U 16A', 'Cable Manager 1U Brush Strip',
      'Rack Drawer 1U 19" for Accessories', 'Cantilever Shelf 1U Fixed 19" 480mm',
      'Blanking Panel 1U 19" Black 10-pack', 'D-Link ANT24-0800 8dBi Patch Panel Antenna',
      'Rack Fan Tray 2U 19" 4 Fan 230V', 'LCD KVM Drawer 17" 19" 1U Rack',
    ],
  },

  // ─── BỔ SUNG: CAMERA IP / CCTV ────────────────────────────────────────
  {
    parentCategory: 'Thiết Bị CNTT',
    category: 'Camera IP & CCTV',
    slug: 'camera-ip-cctv',
    brand: 'Hikvision / Dahua',
    imageQuery: 'Hikvision IP camera 4K dome bullet CCTV official product',
    fallbackKey: 'default',
    quota: 30,
    products: [
      'Hikvision DS-2CD2143G2-I 4MP Dome PoE', 'Hikvision DS-2CD2347G2-LU 4MP ColorVu',
      'Hikvision DS-2CD2T47G2-L 4MP AcuSense Bullet', 'Hikvision DS-2CD2T87G2-L 8MP Bullet',
      'Hikvision DS-2CD2347G2H-LI/SL Strobe', 'Hikvision DS-2DE4425IWG-E PTZ 4MP 25x',
      'Hikvision DS-2CD2085G1-I 8MP WDR Bullet', 'Hikvision DS-2CD2543G2-IS 4MP WDR',
      'Hikvision DS-7608NI-K2/8P NVR 8CH PoE', 'Hikvision DS-7716NI-K4/16P NVR 16CH',
      'Dahua IPC-HDW2831T-AS 8MP Dome PoE', 'Dahua IPC-HFW2849S-S-IL 8MP Smart Dual',
      'Dahua SD49425XB-HNR 4MP PTZ 25x AI', 'Dahua DH-NVR4116HS-8P-I/L 16CH NVR',
      'Dahua IPC-HFW3849H-AS-PV 8MP ColorVu', 'Dahua DH-HAC-HDW1200TLP-A 2MP HDCVI',
      'Axis P3245-V Fixed Dome 1080P', 'Axis P5655-E 2MP PTZ HDTV 32x',
      'Axis M3106-L Mk II Fixed Dome', 'Bosch FLEXIDOME 5100i 2MP Varifocal',
      'Bosch AUTODOME IP 7000 HD PTZ 20x', 'Hanwha Vision XNV-8080R 5MP QNO IR',
      'Uniview IPC3618SB-ADF40KM 8MP Bullet', 'Uniview NVR301-16S2-P16 16CH NVR PoE',
      'Vivotek FD9387-EHV-A 5MP Fisheye Dome', 'Sony SNC-EM632R 1.3MP Day/Night',
      'Tiandy TC-C38WQ 8MP Lite ColorNight', 'Reolink RLC-810A 4K PoE AI Bullet',
      'Milesight MS-C5364-EPC 5MP AI Fisheye', 'Wisenet Q QNO-8080R 5MP IR Bullet',
    ],
  },
];
