...
async function migrate() {
    try {
        ...
        const sqlCategories = categoriesResult.recordset;
        ...
        const sqlProducts = productsResult.recordset;
        ...
        const blogsResult = await sql.query`SELECT * FROM Blog`;
        const sqlBlogs = blogsResult.recordset;
        ...
        for (const blog of sqlBlogs) {
            try {
                const newBlog = new News({
                    ...
                    publishedAt: blog.CreateTime || new Date(),
