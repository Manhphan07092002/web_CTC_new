      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-violet-500/20 border border-violet-400/30 text-violet-300 px-5 py-2 rounded-full text-sm font-bold uppercase tracking-widest mb-6 backdrop-blur-sm">
            <Server size={16} />
            {isEn ? 'Digital Infrastructure – CTC Digital' : 'Hạ tầng số – CTC Digital'}
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight tracking-tight">
            Data Center & <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-300">
              {isEn ? 'Digital Infrastructure' : 'Hạ Tầng Số CNTT'}
            </span>
          </h1>
          <p className="text-lg text-gray-200 leading-relaxed max-w-2xl font-light">
            {isEn ? (
              <>CTC designs, builds, and operates Data Centers to <strong className="text-white">Tier III</strong> standards. Enterprise IT, networking, AI security cameras, and digital transformation for government and commercial organizations.</>
            ) : (
              <>CTC thiết kế, xây dựng và vận hành Trung tâm Dữ liệu chuẩn <strong className="text-white">Tier III</strong>. Hệ thống CNTT, mạng doanh nghiệp, camera an ninh và chuyển đổi số cho cơ quan nhà nước và doanh nghiệp toàn quốc.</>
            )}
          </p>
        </div>
      </div>
